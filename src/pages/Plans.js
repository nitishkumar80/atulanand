    ...
    <>
        ...
        <div className="title">
          ...
          <div className="">
            <p>
              ...
              Ars memberships are for those who insist on the best.
            </p>
          </div>
        </div>
      </div>
      <div className="plan__container">
        ...
        >
          ...
          <p>
            Ars Gym is not your average health club; our membership plans,
      ...
      <div className="join-us">
        <div className="joinus--container">
          ...
          >
            <h3>How to Join</h3>
            <p>
              Apply online or visit your nearest club and activate your Ars
      ...
      >
        ...
        <div className="plans--ben--cont">
          ...
          <div className="plans-b">
            <p>
              <i className="fas fa-check-circle"></i>150+ Certified Personal
              Trainers
            </p>
            <p>
